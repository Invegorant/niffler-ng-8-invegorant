...
public class UserEntity implements Serializable {
    ...
    public static UserEntity fromJson(UserJson user) {
        ...
        ue.setPhoto(user.photo() != null ? user.photo().getBytes(StandardCharsets.UTF_8) : null);
        ue.setPhotoSmall(user.photoSmall() != null ? user.photoSmall().getBytes(StandardCharsets.UTF_8) : null);
        return ue;
    }
